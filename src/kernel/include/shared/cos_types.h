...
#define MAGIC_LEN 8
/* ivshmem layout. total ivshmem is 650M, see qemu-ivshmem.sh
 ...
 * the rest 618M are untyped memory, managed by user level (rpc or memcached) */
#define IVSHMEM_TOT_SIZE     (PGD_SIZE/4*650)
...
#define IVSHMEM_LTBL_BASE (1<<LTBL_ENT_ORDER)
